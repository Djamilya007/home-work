...
6. Перед only в значении "единственный"''')
		...
		self.completion1.clicked.connect(self.Next4)
		...
		self.completion2.clicked.connect(self.Next5)
		...
		grid8.addWidget(self.answer2, 2, 1)

		self.answer5 = QPushButton('''are''',self)
		self.answer5.clicked.connect(self.test1)
		grid8.addWidget(self.question2, 2,0)
		grid8.addWidget(self.answer5, 2, 2)


		self.answer9 = QPushButton('''is''',self)
		self.answer9.clicked.connect(self.test1)
		grid8.addWidget(self.question2, 2,0)
		grid8.addWidget(self.answer9, 2, 3)
	 

		self.question3 = QLabel('''What ... your name''')
		self.answer3 = QPushButton('''am''',self)
		self.answer3.clicked.connect(self.test1)
		grid8.addWidget(self.question3, 3, 0)
		grid8.addWidget(self.answer3, 3, 1)

		self.answer5 = QPushButton('''are''',self)
		self.answer5.clicked.connect(self.test1)
		grid8.addWidget(self.question3, 3,0)
		grid8.addWidget(self.answer5, 3, 2)


		self.answer6 = QPushButton('''is''',self)
		self.answer6.clicked.connect(self.test1)
		grid8.addWidget(self.question3, 3,0)
		grid8.addWidget(self.answer6, 3, 3)

		self.question4 = QLabel('''I ... glad to see you''')
		
		self.answer4 = QPushButton('''are''',self)
		self.answer4.clicked.connect(self.test1)
		grid8.addWidget(self.question4, 4,0)
		grid8.addWidget(self.answer4, 4, 1)

		self.answer4 = QPushButton('''am''',self)
		self.answer4.clicked.connect(self.test1)
		grid8.addWidget(self.question4, 4,0)
		grid8.addWidget(self.answer4, 4, 2)


		self.answer7 = QPushButton('''is''',self)
		self.answer7.clicked.connect(self.test1)
		grid8.addWidget(self.question4, 4,0)
		grid8.addWidget(self.answer7, 4, 3)

		
		self.question5 = QLabel('''...Igor a good chess player?''')
		self.answer3 = QPushButton('''am''',self)
		self.answer3.clicked.connect(self.test1)
		grid8.addWidget(self.question5, 5, 0)
		grid8.addWidget(self.answer3, 5, 1)

		self.answer5 = QPushButton('''are''',self)
		self.answer5.clicked.connect(self.test1)
		grid8.addWidget(self.question5, 5,0)
		grid8.addWidget(self.answer5, 5, 2)

		self.answer2 = QPushButton('''is''',self)
		self.answer2.clicked.connect(self.test1)
		grid8.addWidget(self.question5, 5,0)
		grid8.addWidget(self.answer2, 5, 3)
